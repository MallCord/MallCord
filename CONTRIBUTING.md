...
We have development documentation for new contributors, which can be found at <https://docs.mallcord.org>.
...
We have an open support channel in our [Discord community](https://mallcord.org/discord).
